...
<body>
	...
	<div class="container" role="main">
		<form id="uploadForm" method="post" action="add" enctype="multipart/form-data">
			...
			<div>
				<label>총시비량:</label> <input name="total" type="text" class="form-control">
			</div>
			<div>
				<label>기비량:</label> <input name="basal" type="text" class="form-control">
			</div>
			<div>
				<label>기비시기:</label> <input name="fer" type="text" class="form-control">
			</div>
			<div>
				<label>추비횟수:</label> <input name="dress" type="text" class="form-control">
			</div>
			<div>
				<label>관개유무:</label> <input name="irri" type="text" class="form-control">
			</div>
			<div>
