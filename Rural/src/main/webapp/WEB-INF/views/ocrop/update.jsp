...
<div class="container">
	...
	<div class="container" role="main">
		<form method="post"  enctype="multipart/form-data">
			...
			<div>
				<label>표본구역:</label> <input name="area" type="text" value="${item.area}" class="form-control">
			</div>
			<div>
				<label>정상포기수:</label> <input name="nor" type="text" value="${item.nor}" class="form-control">
			</div>
			<div>
				<label>추대포기수:</label> <input name="bol" type="text" value="${item.bol}" class="form-control">
			</div>
			<div>
				<label>생중량:</label> <input name="fre" type="text" value="${item.fre}" class="form-control">
			</div>
			<div>
				<label>지하부건물중:</label> <input name="udry" type="text" value="${item.udry}" class="form-control">
			</div>
			<div>
				<label>지상부건물중:</label> <input name="adry" type="text" value="${item.adry}" class="form-control">
			</div>
			<div>
				<label>구직경:</label> <input name="dia" type="text" value="${item.dia}" class="form-control">
			</div>
			<div>
				<label>초장:</label> <input name="pla" type="text" value="${item.pla}" class="form-control">
			</div>
			<div>
