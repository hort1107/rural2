...
<div class="container">
	...
	<div class="container" role="main">
		<form method="post"  enctype="multipart/form-data">
			<div class="mb-3">
				<label>아이디:</label> <input name="id" type="text" value="${item.id}"  class="form-control">
			</div>
			<div>
				<label>비밀번호:</label> <input name="passwd" type="text" value="${item.passwd}"  class="form-control">
			</div>
			<div>
				<label>이름:</label> <input name="name" type="text" value="${item.name}"  class="form-control">
			</div>
			<div>
				<label>전화번호:</label> <input name="tel" type="text" value="${item.tel}"  class="form-control">
			</div>
			<div>
				<label>직책:</label> <input name="job" type="text" value="${item.job}"  class="form-control">
			</div>
			<div>
				<label>회사부서:</label> <input name="dep" type="text" value="${item.dep}"  class="form-control">
			</div>
			<div>
