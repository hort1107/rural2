...
<div class="container">
	...
	<div class="container" role="main">
		<form id="uploadForm" method="post" action="add" enctype="multipart/form-data">
			<div class="mb-3">
				<label>아이디:</label> <input name="id" type="text" class="form-control" placeholder="아이디를 입력해 주세요">
			</div>
			<div>
				<label>비밀번호:</label> <input name="passwd" type="text" class="form-control">
			</div>
			<div>
				<label>이름:</label> <input name="name" type="text" class="form-control">
			</div>
			<div>
				<label>전화번호:</label> <input name="tel" type="text" class="form-control">
			</div>
			<div>
				<label>직책:</label> <input name="job" type="text" class="form-control">
			</div>
			<div>
				<label>회사부서:</label> <input name="dep" type="text" class="form-control">
			</div>
			<div>
