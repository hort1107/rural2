...
<div class="container">
	...
	<div class="container" role="main">
		<form method="post"  enctype="multipart/form-data">
			...
			<div>
				<label>위도:</label> <input name="lat" type="text" value="${item.lat}" class="form-control">
			</div>
			<div>
				<label>경도:</label> <input name="lon" type="text" value="${item.lon}" class="form-control">
			</div>
			<div>
				<label>파종일:</label> <input name="pla" type="text" value="${item.pla}" class="form-control">
			</div>
			<div>
				<label>정식일:</label> <input name="tra" type="text" value="${item.tra}" class="form-control">
			</div>
			<div>
				<label>정식일건물중:</label> <input name="dry" type="text" value="${item.dry}" class="form-control">
			</div>
			<div>
