...
<body>
	...
	<div class="container" role="main">
		<form id="uploadForm" method="post" action="add" enctype="multipart/form-data">
			...
			<div>
				<label>바이러스병:</label> <input name="vir" type="text" class="form-control">
			</div>
			<div>
				<label>무름병:</label> <input name="sof" type="text" class="form-control">
			</div>
			<div>
				<label>무사마귀병:</label> <input name="clu" type="text" class="form-control">
			</div>
			<div>
				<label>파밤나방:</label> <input name="bee" type="text" class="form-control">
			</div>
			<div>
				<label>담배거세미나방:</label> <input name="lit" type="text" class="form-control">
			</div>
			<div>
				<label>기상재해:</label> <input name="met" type="text" class="form-control">
			</div>
			<div>
