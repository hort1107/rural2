...
<body>
	...
	<div class="container" role="main">
		<form id="uploadForm" method="post" action="add" enctype="multipart/form-data">
			...
			<div>
				<label>노균병:</label> <input name="dow" type="text" class="form-control">
			</div>
			<div>
				<label>검은무늬:</label> <input name="pur" type="text" class="form-control">
			</div>
			<div>
				<label>잎마름:</label> <input name="leaf" type="text" class="form-control">
			</div>
			<div>
				<label>흑색썩음균핵병:</label> <input name="white" type="text" class="form-control">
			</div>
			<div>
				<label>고자리파리:</label> <input name="delia" type="text" class="form-control">
			</div>
			<div>
				<label>기상재해:</label> <input name="meteo" type="text" class="form-control">
			</div>
			<div>
