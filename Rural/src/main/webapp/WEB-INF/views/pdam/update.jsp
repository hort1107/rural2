...
<div class="container">
	...
	<div class="container" role="main">
		<form method="post"  enctype="multipart/form-data">
			...
			<div>
				<label>역병:</label> <input name="phy" type="text" value="${item.phy}" class="form-control">
			</div>
			<div>
				<label>탄저병:</label> <input name="ant" type="text" value="${item.ant}" class="form-control">
			</div>
			<div>
				<label>담배나방:</label> <input name="ori" type="text" value="${item.ori}" class="form-control">
			</div>
			<div>
				<label>총채벌레류:</label> <input name="thr" type="text" value="${item.thr}" class="form-control">
			</div>
			<div>
