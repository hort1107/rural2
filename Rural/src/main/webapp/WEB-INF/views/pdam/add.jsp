...
<body>
	...
	<div class="container" role="main">
		<form id="uploadForm" method="post" action="add" enctype="multipart/form-data">
			...
			<div>
				<label>역병:</label> <input name="phy" type="text" class="form-control">
			</div>
			<div>
				<label>탄저병:</label> <input name="ant" type="text" class="form-control">
			</div>
			<div>
				<label>담배나방:</label> <input name="ori" type="text" class="form-control">
			</div>
			<div>
				<label>총채벌레류:</label> <input name="thr" type="text" class="form-control">
			</div>
			<div>
