...
<div class="container">
	...
	<div class="container" role="main">
		<form method="post"  enctype="multipart/form-data">
			...
			<div>
				<label>포기수:</label> <input name="plan" type="text" value="${item.plan}" class="form-control">
			</div>
			<div>
				<label>개화비율:</label> <input name="per" type="text" value="${item.per}" class="form-control">
			</div>
			<div>
				<label>생중량:</label> <input name="fwe" type="text" value="${item.fwe}" class="form-control">
			</div>
			<div>
				<label>잎건물중:</label> <input name="ldr" type="text" value="${item.ldr}" class="form-control">
			</div>
			<div>
				<label>줄기건물중:</label> <input name="sdr" type="text" value="${item.sdr}" class="form-control">
			</div>
			<div>
				<label>초장:</label> <input name="pla" type="text" value="${item.pla}" class="form-control">
			</div>
			<div>
				<label>주당착과수:</label> <input name="fru" type="text" value="${item.fru}" class="form-control">
			</div>
			<div>
