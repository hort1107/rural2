...
<div class="container">
	...
	<div class="container" role="main">
		<form method="post"  enctype="multipart/form-data">
			...
			<div>
				<label>미결구포기수:</label> <input name="non" type="text" value="${item.non}" class="form-control">
			</div>
			<div>
			...
			<div>
				<label>구중:</label> <input name="hea" type="text" value="${item.hea}" class="form-control">
			</div>
			<div>
				<label>초장:</label> <input name="pla" type="text" value="${item.pla}" class="form-control">
			</div>
			<div>
				<label>엽수:</label> <input name="lea" type="text" value="${item.lea}" class="form-control">
			</div>
			<div>
