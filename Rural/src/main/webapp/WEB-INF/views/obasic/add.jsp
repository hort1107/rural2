...
<head>
<meta charset="UTF-8">
<title>양파 기초정보 등록</title>
<script src="/js/jquery-3.6.0.min.js"></script>
<link href="${path}/resources/css/croplist.css" rel="stylesheet" />
<link
...
<div class="container">
	...
	<div class="container" role="main">
		<form id="uploadForm" method="post" action="add" enctype="multipart/form-data">
			...
			<div>
				<label>위도:</label> <input name="lat" type="text" class="form-control">
			</div>
			<div>
				<label>경도:</label> <input name="lon" type="text" class="form-control">
			</div>
			<div>
				<label>파종일:</label> <input name="pla" type="text" class="form-control">
			</div>
			<div>
				<label>정식일:</label> <input name="tra" type="text" class="form-control">
			</div>
			<div>
				<label>정식일건물중:</label> <input name="dry" type="text" class="form-control">
			</div>
			<div>
