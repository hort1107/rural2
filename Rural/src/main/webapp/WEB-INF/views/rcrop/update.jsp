...
<div class="container">
	...
	<div class="container" role="main">
		<form method="post"  enctype="multipart/form-data">
			...
			<div>
				<label>지하부생중량:</label> <input name="fwe" type="text" value="${item.fwe}" class="form-control">
			</div>
			<div>
				<label>지하부건물중:</label> <input name="dwe" type="text" value="${item.dwe}" class="form-control">
			</div>
			<div>
				<label>지상부건물중:</label> <input name="adwe" type="text" value="${item.adwe}" class="form-control">
			</div>
			<div>
