...
<body>
	...
	<div class="container" role="main">
		<form id="uploadForm" method="post" action="add" enctype="multipart/form-data">
			...
			<div>
				<label>지하부생중량:</label> <input name="fwe" type="text" class="form-control">
			</div>
			<div>
				<label>지하부건물중:</label> <input name="dwe" type="text" class="form-control">
			</div>
			<div>
				<label>지상부건물중:</label> <input name="adwe" type="text" class="form-control">
			</div>
			<div>
