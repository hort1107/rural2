...
import kr.ac.kopo.rural.service.CcropService;
import kr.ac.kopo.rural.util.Pager;



@Controller
@RequestMapping("/ccrop")
public class CcropController {
final String path = "ccrop/";
final private String uploadpath = "d://upload/";

	@Autowired
	CcropService service;
	
	@RequestMapping("/list")
	String list(Model model, Pager pager) {
		List<Ccrop> list = service.list(pager);
	...
	String update(int seq5, Model model) {
		Ccrop item = service.item(seq5);
