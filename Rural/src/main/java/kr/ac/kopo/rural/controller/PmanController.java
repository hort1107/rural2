...
import kr.ac.kopo.rural.service.PmanService;
import kr.ac.kopo.rural.util.Pager;

@Controller
@RequestMapping("/pman")
public class PmanController {
final String path = "pman/";
final private String uploadpath = "d://upload/";
	...
	String list(Model model, Pager pager) {
		List<Pman> list = service.list(pager);
	...
	String delete(int seq10) {
		service.delete(seq10);
	...
	String update(int seq10, Model model) {
		Pman item = service.item(seq10);
