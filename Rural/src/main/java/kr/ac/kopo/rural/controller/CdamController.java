...
import kr.ac.kopo.rural.service.CdamService;
import kr.ac.kopo.rural.util.Pager;

@Controller
@RequestMapping("/cdam")
public class CdamController {
final String path = "cdam/";
final private String uploadpath = "d://upload/";
	...
	String list(Model model, Pager pager) {
		List<Cdam> list = service.list(pager);
	...
	String update(int seq6, Model model) {
		Cdam item = service.item(seq6);
