...
import kr.ac.kopo.rural.service.RcropService;
import kr.ac.kopo.rural.util.Pager;



@Controller
@RequestMapping("/rcrop")
public class RcropController {
final String path = "rcrop/";
final private String uploadpath = "d://upload/";

	@Autowired
	RcropService service;
	
	@RequestMapping("/list")
	String list(Model model, Pager pager) {
		List<Rcrop> list = service.list(pager);
	...
	String update(int seq8, Model model) {
		Rcrop item = service.item(seq8);
