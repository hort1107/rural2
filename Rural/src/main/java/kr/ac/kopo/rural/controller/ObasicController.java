...
import kr.ac.kopo.rural.service.ObasicService;
import kr.ac.kopo.rural.util.Pager;

@Controller
@RequestMapping("/obasic")
public class ObasicController {
final String path = "obasic/";
final private String uploadpath = "d://upload/";

	@Autowired
	ObasicService service;
	
	@RequestMapping("/list")
	String list(Model model, Pager pager) {
		List<Obasic> list = service.list(pager);
