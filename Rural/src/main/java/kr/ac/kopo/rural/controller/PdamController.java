...
import kr.ac.kopo.rural.service.PdamService;
import kr.ac.kopo.rural.util.Pager;

@Controller
@RequestMapping("/pdam")
public class PdamController {
final String path = "pdam/";
final private String uploadpath = "d://upload/";
	...
	String list(Model model, Pager pager) {
		List<Pdam> list = service.list(pager);
	...
	String delete(int seq12) {
		service.delete(seq12);
	...
	String update(int seq12, Model model) {
		Pdam item = service.item(seq12);
