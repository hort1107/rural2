...
import kr.ac.kopo.rural.service.NotiService;
import kr.ac.kopo.rural.util.Pager;

@Controller
@RequestMapping("/noti")
public class NotiController {
final String path = "noti/";
final private String uploadpath = "d://upload/";
	...
	String list(Model model, Pager pager) {
		List<Noti> list = service.list(pager);
	...
	String delete(int seq13) {
		service.delete(seq13);
	...
	String update(int seq13, Model model) {
		Noti item = service.item(seq13);
