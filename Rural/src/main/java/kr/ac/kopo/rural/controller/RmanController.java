...
import kr.ac.kopo.rural.service.RmanService;
import kr.ac.kopo.rural.util.Pager;

@Controller
@RequestMapping("/rman")
public class RmanController {
final String path = "rman/";
final private String uploadpath = "d://upload/";
	...
	String list(Model model, Pager pager) {
		List<Rman> list = service.list(pager);
	...
	String update(int seq7, Model model) {
		Rman item = service.item(seq7);
