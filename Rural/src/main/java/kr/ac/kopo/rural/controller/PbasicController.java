...
import kr.ac.kopo.rural.service.PbasicService;
import kr.ac.kopo.rural.util.Pager;

@Controller
@RequestMapping("/pbasic")
public class PbasicController {
final String path = "pbasic/";
final private String uploadpath = "d://upload/";
	
	@Autowired
	PbasicService service;
	
	@RequestMapping("/list")
	String list(Model model, Pager pager) {
		List<Pbasic> list = service.list(pager);
